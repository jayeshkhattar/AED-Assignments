            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(27, 27, 27)
                        .addComponent(deliveryManCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnUpdateStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateStatusActionPerformed
        ...
        if(orderStatus.equals(Order.orderPlaced)) {
            ...
            if(status.equals(Order.orderReady))
                order.setOrderStatus(Order.orderReady);
            else {
                JOptionPane.showMessageDialog(null,"Please update correct status", "Warining", JOptionPane.WARNING_MESSAGE);
                return;
            }            
        }        
        else if(orderStatus.equals(Order.orderReady)) {
            if(status.equals(Order.orderOnDelivery)) {
